...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 13 11:37:48 2018
...
for filename in testdata:
    ...
    lem_reviewwords=[]
    for item in reviewwords:
        w = Word(item)
        lem_reviewwords.append(w.lemmatize())
    ...
    if filepolarity == user_defined_keywords(lem_reviewwords):
        keywordscorrect += 1

    if filepolarity == naive_bayes(lem_reviewwords):
        nbcorrect += 1
    
    if filepolarity == textblob(' '.join(lem_reviewwords)):
        tblobcorrect += 1
        
        
print("Lemmatized User keyword accuracy: ", (keywordscorrect/200))
print("Lemmatized Naive Bayes accuracy: ", (nbcorrect/200))
print("Lemmatized Textblob Sentiment accuracy: ", (tblobcorrect/200))
